...
Estes comandos irão criar as tabelas necessárias na sua base de dados rede_doacoes.
...
A aplicação estará disponível no seu navegador no seguinte endereço: [**http://127.0.0.1:5000**](http://127.0.0.1:5000)
